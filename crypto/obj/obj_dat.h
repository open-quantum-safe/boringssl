...
static const ASN1_OBJECT kObjects[NUM_NID] = {
    ...
    {NULL, NULL, NID_undef, 0, NULL, 0},
    {"mldsa65", "mldsa65", NID_mldsa65, 9, &kObjectData[6205], 0},
    {"p384_mldsa65", "p384_mldsa65", NID_p384_mldsa65, 5, &kObjectData[6214],
     0},
    {"mldsa87", "mldsa87", NID_mldsa87, 9, &kObjectData[6219], 0},
    {NULL, NULL, NID_undef, 0, NULL, 0},
    {NULL, NULL, NID_undef, 0, NULL, 0},
    {NULL, NULL, NID_undef, 0, NULL, 0},
    {"falcon512", "falcon512", NID_falcon512, 5, &kObjectData[6228], 0},
    {NULL, NULL, NID_undef, 0, NULL, 0},
    {"falconpadded512", "falconpadded512", NID_falconpadded512, 5,
     &kObjectData[6233], 0},
    {"falcon1024", "falcon1024", NID_falcon1024, 5, &kObjectData[6238], 0},
    {"falconpadded1024", "falconpadded1024", NID_falconpadded1024, 5,
     &kObjectData[6243], 0},
    {"mayo1", "mayo1", NID_mayo1, 6, &kObjectData[6248], 0},
    {"mayo2", "mayo2", NID_mayo2, 6, &kObjectData[6254], 0},
    {"mayo3", "mayo3", NID_mayo3, 6, &kObjectData[6260], 0},
    {"mayo5", "mayo5", NID_mayo5, 6, &kObjectData[6266], 0},
    {"sphincssha2128fsimple", "sphincssha2128fsimple",
     NID_sphincssha2128fsimple, 6, &kObjectData[6272], 0},
    {"sphincssha2128ssimple", "sphincssha2128ssimple",
     NID_sphincssha2128ssimple, 6, &kObjectData[6278], 0},
    {"sphincssha2192fsimple", "sphincssha2192fsimple",
     NID_sphincssha2192fsimple, 6, &kObjectData[6284], 0},
    {"sphincssha2192ssimple", "sphincssha2192ssimple",
     NID_sphincssha2192ssimple, 6, &kObjectData[6290], 0},
    {"sphincssha2256fsimple", "sphincssha2256fsimple",
     NID_sphincssha2256fsimple, 6, &kObjectData[6296], 0},
    {"sphincssha2256ssimple", "sphincssha2256ssimple",
     NID_sphincssha2256ssimple, 6, &kObjectData[6302], 0},
    {"sphincsshake128fsimple", "sphincsshake128fsimple",
     NID_sphincsshake128fsimple, 6, &kObjectData[6308], 0},
    {"sphincsshake128ssimple", "sphincsshake128ssimple",
     NID_sphincsshake128ssimple, 6, &kObjectData[6314], 0},
    {"sphincsshake192fsimple", "sphincsshake192fsimple",
     NID_sphincsshake192fsimple, 6, &kObjectData[6320], 0},
    {"sphincsshake192ssimple", "sphincsshake192ssimple",
     NID_sphincsshake192ssimple, 6, &kObjectData[6326], 0},
    {"sphincsshake256fsimple", "sphincsshake256fsimple",
     NID_sphincsshake256fsimple, 6, &kObjectData[6332], 0},
    {"sphincsshake256ssimple", "sphincsshake256ssimple",
     NID_sphincsshake256ssimple, 6, &kObjectData[6338], 0},
    {"p256_mlkem768", "p256_mlkem768", NID_p256_mlkem768, 0, NULL, 0},
    {"p384_mlkem1024", "p384_mlkem1024", NID_p384_mlkem1024, 0, NULL, 0},
    {NULL, NULL, NID_undef, 0, NULL, 0},
    {"p256_mldsa44", "p256_mldsa44", NID_p256_mldsa44, 5, &kObjectData[6344],
     0},
    {"p521_mldsa87", "p521_mldsa87", NID_p521_mldsa87, 5, &kObjectData[6349],
     0},
    ...
    {"CROSSrsdp128balanced", "CROSSrsdp128balanced", NID_CROSSrsdp128balanced,
     12, &kObjectData[6359], 0},
    {NULL, NULL, NID_undef, 0, NULL, 0},
    {"OV_Ip_pkc", "OV_Ip_pkc", NID_OV_Ip_pkc, 6, &kObjectData[6371], 0},
    {NULL, NULL, NID_undef, 0, NULL, 0},
    {"OV_Ip_pkc_skc", "OV_Ip_pkc_skc", NID_OV_Ip_pkc_skc, 6, &kObjectData[6377],
     0},
    {"snova2454", "snova2454", NID_snova2454, 6, &kObjectData[6383], 0},
    {"snova2454esk", "snova2454esk", NID_snova2454esk, 6, &kObjectData[6389],
     0},
    {"snova37172", "snova37172", NID_snova37172, 6, &kObjectData[6395], 0},
    {"snova2455", "snova2455", NID_snova2455, 6, &kObjectData[6401], 0},
    {"snova2965", "snova2965", NID_snova2965, 6, &kObjectData[6407], 0},
};
...
static const uint16_t kNIDsInShortNameOrder[] = {
    ...
    1019 /* falcon1024 */,
    1016 /* falcon512 */,
    1020 /* falconpadded1024 */,
    1018 /* falconpadded512 */,
    462 /* favouriteDrink */,
    857 /* freshestCRL */,
    453 /* friendlyCountry */,
    ...
    876 /* owner */,
    995 /* p256_bikel1 */,
    974 /* p256_frodo640aes */,
    977 /* p256_frodo640shake */,
    1040 /* p256_mldsa44 */,
    967 /* p256_mlkem512 */,
    1037 /* p256_mlkem768 */,
    998 /* p384_bikel3 */,
    ...
    1052 /* snova2965 */,
    1050 /* snova37172 */,
    1025 /* sphincssha2128fsimple */,
    1026 /* sphincssha2128ssimple */,
    1027 /* sphincssha2192fsimple */,
    1028 /* sphincssha2192ssimple */,
    1029 /* sphincssha2256fsimple */,
    1030 /* sphincssha2256ssimple */,
    1031 /* sphincsshake128fsimple */,
    1032 /* sphincsshake128ssimple */,
    1033 /* sphincsshake192fsimple */,
    1034 /* sphincsshake192ssimple */,
    1035 /* sphincsshake256fsimple */,
    1036 /* sphincsshake256ssimple */,
    660 /* street */,
    85 /* subjectAltName */,
    ...
    868 /* x121Address */,
    996 /* x25519_bikel1 */,
    975 /* x25519_frodo640aes */,
    978 /* x25519_frodo640shake */,
    968 /* x25519_mlkem512 */,
...
static const uint16_t kNIDsInOIDOrder[] = {
    ...
    1016 /* 1.3.9999.3.11 (OBJ_falcon512) */,
    1042 /* 1.3.9999.3.13 (OBJ_rsa3072_falcon512) */,
    1019 /* 1.3.9999.3.14 (OBJ_falcon1024) */,
    1018 /* 1.3.9999.3.16 (OBJ_falconpadded512) */,
    1020 /* 1.3.9999.3.19 (OBJ_falconpadded1024) */,
    1040 /* 1.3.9999.7.5 (OBJ_p256_mldsa44) */,
    1011 /* 1.3.9999.7.7 (OBJ_p384_mldsa65) */,
    1041 /* 1.3.9999.7.8 (OBJ_p521_mldsa87) */,
    ...
    1025 /* 1.3.9999.6.4.13 (OBJ_sphincssha2128fsimple) */,
    1026 /* 1.3.9999.6.4.16 (OBJ_sphincssha2128ssimple) */,
    1027 /* 1.3.9999.6.5.10 (OBJ_sphincssha2192fsimple) */,
    1028 /* 1.3.9999.6.5.12 (OBJ_sphincssha2192ssimple) */,
    1029 /* 1.3.9999.6.6.10 (OBJ_sphincssha2256fsimple) */,
    1030 /* 1.3.9999.6.6.12 (OBJ_sphincssha2256ssimple) */,
    1031 /* 1.3.9999.6.7.13 (OBJ_sphincsshake128fsimple) */,
    1032 /* 1.3.9999.6.7.16 (OBJ_sphincsshake128ssimple) */,
    1033 /* 1.3.9999.6.8.10 (OBJ_sphincsshake192fsimple) */,
    1034 /* 1.3.9999.6.8.12 (OBJ_sphincsshake192ssimple) */,
    1035 /* 1.3.9999.6.9.10 (OBJ_sphincsshake256fsimple) */,
    1036 /* 1.3.9999.6.9.12 (OBJ_sphincsshake256ssimple) */,
    1021 /* 1.3.9999.8.1.3 (OBJ_mayo1) */,
    1022 /* 1.3.9999.8.2.3 (OBJ_mayo2) */,
    1023 /* 1.3.9999.8.3.3 (OBJ_mayo3) */,
    1024 /* 1.3.9999.8.5.3 (OBJ_mayo5) */,
    1045 /* 1.3.9999.9.6.1 (OBJ_OV_Ip_pkc) */,
    1047 /* 1.3.9999.9.10.1 (OBJ_OV_Ip_pkc_skc) */,
    1048 /* 1.3.9999.10.1.1 (OBJ_snova2454) */,
    1049 /* 1.3.9999.10.3.1 (OBJ_snova2454esk) */,
    1050 /* 1.3.9999.10.5.1 (OBJ_snova37172) */,
    1051 /* 1.3.9999.10.10.1 (OBJ_snova2455) */,
    1052 /* 1.3.9999.10.12.1 (OBJ_snova2965) */,
    ...
    1043 /* 1.3.6.1.4.1.62245.2.1.1.2 (OBJ_CROSSrsdp128balanced) */,
};
