...
static const ASN1_OBJECT kObjects[NUM_NID] = {
    ...
    {"p521_frodo1344shake", "p521_frodo1344shake", NID_p521_frodo1344shake, 0,
     NULL, 0},
    {"bikel1", "bikel1", NID_bikel1, 0, NULL, 0},
    {"p256_bikel1", "p256_bikel1", NID_p256_bikel1, 0, NULL, 0},
    ...
    {"mldsa44", "mldsa44", NID_mldsa44, 9, &kObjectData[6196], 0},
    {"p256_mldsa44", "p256_mldsa44", NID_p256_mldsa44, 5, &kObjectData[6205],
     0},
    {"mldsa65", "mldsa65", NID_mldsa65, 9, &kObjectData[6210], 0},
    {"p384_mldsa65", "p384_mldsa65", NID_p384_mldsa65, 5, &kObjectData[6219],
     0},
    {"mldsa87", "mldsa87", NID_mldsa87, 9, &kObjectData[6224], 0},
    {"p521_mldsa87", "p521_mldsa87", NID_p521_mldsa87, 5, &kObjectData[6233],
     0},
    {"falcon512", "falcon512", NID_falcon512, 5, &kObjectData[6238], 0},
    {"rsa3072_falcon512", "rsa3072_falcon512", NID_rsa3072_falcon512, 5,
     &kObjectData[6243], 0},
    {"falconpadded512", "falconpadded512", NID_falconpadded512, 5,
     &kObjectData[6248], 0},
    {"falcon1024", "falcon1024", NID_falcon1024, 5, &kObjectData[6253], 0},
    {"falconpadded1024", "falconpadded1024", NID_falconpadded1024, 5,
     &kObjectData[6258], 0},
    {"mayo1", "mayo1", NID_mayo1, 6, &kObjectData[6263], 0},
    {"mayo2", "mayo2", NID_mayo2, 6, &kObjectData[6269], 0},
    {"mayo3", "mayo3", NID_mayo3, 6, &kObjectData[6275], 0},
    {"mayo5", "mayo5", NID_mayo5, 6, &kObjectData[6281], 0},
    {"OV_Ip_pkc", "OV_Ip_pkc", NID_OV_Ip_pkc, 6, &kObjectData[6287], 0},
    {"OV_Ip_pkc_skc", "OV_Ip_pkc_skc", NID_OV_Ip_pkc_skc, 6, &kObjectData[6293],
     0},
    {"CROSSrsdp128balanced", "CROSSrsdp128balanced", NID_CROSSrsdp128balanced,
     13, &kObjectData[6299], 0},
    {"snova2454", "snova2454", NID_snova2454, 6, &kObjectData[6312], 0},
    {"snova2454esk", "snova2454esk", NID_snova2454esk, 6, &kObjectData[6318],
     0},
    {"snova37172", "snova37172", NID_snova37172, 6, &kObjectData[6324], 0},
    {"snova2455", "snova2455", NID_snova2455, 6, &kObjectData[6330], 0},
    {"snova2965", "snova2965", NID_snova2965, 6, &kObjectData[6336], 0},
    {"sphincssha2128fsimple", "sphincssha2128fsimple",
     NID_sphincssha2128fsimple, 6, &kObjectData[6342], 0},
    {"sphincssha2128ssimple", "sphincssha2128ssimple",
     NID_sphincssha2128ssimple, 6, &kObjectData[6348], 0},
    {"sphincssha2192fsimple", "sphincssha2192fsimple",
     NID_sphincssha2192fsimple, 6, &kObjectData[6354], 0},
    {"sphincssha2192ssimple", "sphincssha2192ssimple",
     NID_sphincssha2192ssimple, 6, &kObjectData[6360], 0},
    {"sphincssha2256fsimple", "sphincssha2256fsimple",
     NID_sphincssha2256fsimple, 6, &kObjectData[6366], 0},
    {"sphincssha2256ssimple", "sphincssha2256ssimple",
     NID_sphincssha2256ssimple, 6, &kObjectData[6372], 0},
    {"sphincsshake128fsimple", "sphincsshake128fsimple",
     NID_sphincsshake128fsimple, 6, &kObjectData[6378], 0},
    {"sphincsshake128ssimple", "sphincsshake128ssimple",
     NID_sphincsshake128ssimple, 6, &kObjectData[6384], 0},
    {"sphincsshake192fsimple", "sphincsshake192fsimple",
     NID_sphincsshake192fsimple, 6, &kObjectData[6390], 0},
    {"sphincsshake192ssimple", "sphincsshake192ssimple",
     NID_sphincsshake192ssimple, 6, &kObjectData[6396], 0},
    {"sphincsshake256fsimple", "sphincsshake256fsimple",
     NID_sphincsshake256fsimple, 6, &kObjectData[6402], 0},
    {"sphincsshake256ssimple", "sphincsshake256ssimple",
     NID_sphincsshake256ssimple, 6, &kObjectData[6408], 0},
};
...
static const uint16_t kNIDsInShortNameOrder[] = {
    ...
    1005 /* falcon1024 */,
    1002 /* falcon512 */,
    1006 /* falconpadded1024 */,
    1004 /* falconpadded512 */,
    462 /* favouriteDrink */,
    857 /* freshestCRL */,
    453 /* friendlyCountry */,
    ...
    876 /* owner */,
    990 /* p256_bikel1 */,
    976 /* p256_frodo640aes */,
    979 /* p256_frodo640shake */,
    997 /* p256_mldsa44 */,
    968 /* p256_mlkem512 */,
    971 /* p256_mlkem768 */,
    993 /* p384_bikel3 */,
    982 /* p384_frodo976aes */,
    984 /* p384_frodo976shake */,
    999 /* p384_mldsa65 */,
    973 /* p384_mlkem1024 */,
    972 /* p384_mlkem768 */,
    995 /* p521_bikel5 */,
    986 /* p521_frodo1344aes */,
    988 /* p521_frodo1344shake */,
    1001 /* p521_mldsa87 */,
    974 /* p521_mlkem1024 */,
    ...
    868 /* x121Address */,
    991 /* x25519_bikel1 */,
    977 /* x25519_frodo640aes */,
    980 /* x25519_frodo640shake */,
    969 /* x25519_mlkem512 */,
...
static const uint16_t kNIDsInOIDOrder[] = {
    ...
    1002 /* 1.3.9999.3.11 (OBJ_falcon512) */,
    1003 /* 1.3.9999.3.13 (OBJ_rsa3072_falcon512) */,
    1005 /* 1.3.9999.3.14 (OBJ_falcon1024) */,
    1004 /* 1.3.9999.3.16 (OBJ_falconpadded512) */,
    1006 /* 1.3.9999.3.19 (OBJ_falconpadded1024) */,
    997 /* 1.3.9999.7.5 (OBJ_p256_mldsa44) */,
    999 /* 1.3.9999.7.7 (OBJ_p384_mldsa65) */,
    1001 /* 1.3.9999.7.8 (OBJ_p521_mldsa87) */,
    ...
    1007 /* 1.3.9999.8.1.3 (OBJ_mayo1) */,
    1008 /* 1.3.9999.8.2.3 (OBJ_mayo2) */,
    1009 /* 1.3.9999.8.3.3 (OBJ_mayo3) */,
    1010 /* 1.3.9999.8.5.3 (OBJ_mayo5) */,
    1011 /* 1.3.9999.9.6.1 (OBJ_OV_Ip_pkc) */,
    1012 /* 1.3.9999.9.10.1 (OBJ_OV_Ip_pkc_skc) */,
    ...
    996 /* 2.16.840.1.101.3.4.3.17 (OBJ_mldsa44) */,
    998 /* 2.16.840.1.101.3.4.3.18 (OBJ_mldsa65) */,
    1000 /* 2.16.840.1.101.3.4.3.19 (OBJ_mldsa87) */,
    ...
    1013 /* 1.3.6.1.4.1.62245.2.1.1.2.2 (OBJ_CROSSrsdp128balanced) */,
};
