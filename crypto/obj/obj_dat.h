...
static const ASN1_OBJECT kObjects[NUM_NID] = {
    ...
    {NULL, NULL, NID_undef, 0, NULL, 0},
    {NULL, NULL, NID_undef, 0, NULL, 0},
    {"bikel3", "bikel3", NID_bikel3, 0, NULL, 0},
    {"p384_bikel3", "p384_bikel3", NID_p384_bikel3, 0, NULL, 0},
    {"bikel5", "bikel5", NID_bikel5, 0, NULL, 0},
    {"p521_bikel5", "p521_bikel5", NID_p521_bikel5, 0, NULL, 0},
    ...
    {"x25519_frodo640aes", "x25519_frodo640aes", NID_x25519_frodo640aes, 0,
     NULL, 0},
    {"frodo640shake", "frodo640shake", NID_frodo640shake, 0, NULL, 0},
    {"p256_frodo640shake", "p256_frodo640shake", NID_p256_frodo640shake, 0,
     NULL, 0},
    {"x25519_frodo640shake", "x25519_frodo640shake", NID_x25519_frodo640shake,
     0, NULL, 0},
    ...
    {"p384_frodo976shake", "p384_frodo976shake", NID_p384_frodo976shake, 0,
     NULL, 0},
    {"p384_mlkem1024", "p384_mlkem1024", NID_p384_mlkem1024, 0, NULL, 0},
    ...
    {"p256_mlkem768", "p256_mlkem768", NID_p256_mlkem768, 0, NULL, 0},
    {"p384_mlkem768", "p384_mlkem768", NID_p384_mlkem768, 0, NULL, 0},
    {"CROSSrsdp128balanced", "CROSSrsdp128balanced", NID_CROSSrsdp128balanced,
     13, &kObjectData[6205], 0},
    {"OV_Ip_pkc", "OV_Ip_pkc", NID_OV_Ip_pkc, 6, &kObjectData[6218], 0},
    {"OV_Ip_pkc_skc", "OV_Ip_pkc_skc", NID_OV_Ip_pkc_skc, 6, &kObjectData[6224],
     0},
    {"falcon1024", "falcon1024", NID_falcon1024, 5, &kObjectData[6230], 0},
    {"falcon512", "falcon512", NID_falcon512, 5, &kObjectData[6235], 0},
    {"rsa3072_falcon512", "rsa3072_falcon512", NID_rsa3072_falcon512, 5,
     &kObjectData[6240], 0},
    {"falconpadded1024", "falconpadded1024", NID_falconpadded1024, 5,
     &kObjectData[6245], 0},
    {"falconpadded512", "falconpadded512", NID_falconpadded512, 5,
     &kObjectData[6250], 0},
    {"mayo1", "mayo1", NID_mayo1, 6, &kObjectData[6255], 0},
    {"mayo2", "mayo2", NID_mayo2, 6, &kObjectData[6261], 0},
    {"mayo3", "mayo3", NID_mayo3, 6, &kObjectData[6267], 0},
    {"mayo5", "mayo5", NID_mayo5, 6, &kObjectData[6273], 0},
    {"mldsa44", "mldsa44", NID_mldsa44, 9, &kObjectData[6279], 0},
    {"p256_mldsa44", "p256_mldsa44", NID_p256_mldsa44, 5, &kObjectData[6288],
     0},
    {"mldsa65", "mldsa65", NID_mldsa65, 9, &kObjectData[6293], 0},
    {"p384_mldsa65", "p384_mldsa65", NID_p384_mldsa65, 5, &kObjectData[6302],
     0},
    {"mldsa87", "mldsa87", NID_mldsa87, 9, &kObjectData[6307], 0},
    {"p521_mldsa87", "p521_mldsa87", NID_p521_mldsa87, 5, &kObjectData[6316],
     0},
    {"snova2454", "snova2454", NID_snova2454, 6, &kObjectData[6321], 0},
    {"snova2454esk", "snova2454esk", NID_snova2454esk, 6, &kObjectData[6327],
     0},
    {"snova37172", "snova37172", NID_snova37172, 6, &kObjectData[6333], 0},
    {"snova2455", "snova2455", NID_snova2455, 6, &kObjectData[6339], 0},
    {"snova2965", "snova2965", NID_snova2965, 6, &kObjectData[6345], 0},
    {"sphincssha2128fsimple", "sphincssha2128fsimple",
     NID_sphincssha2128fsimple, 6, &kObjectData[6351], 0},
    {"sphincssha2128ssimple", "sphincssha2128ssimple",
     NID_sphincssha2128ssimple, 6, &kObjectData[6357], 0},
    {"sphincssha2192fsimple", "sphincssha2192fsimple",
     NID_sphincssha2192fsimple, 6, &kObjectData[6363], 0},
    {"sphincssha2192ssimple", "sphincssha2192ssimple",
     NID_sphincssha2192ssimple, 6, &kObjectData[6369], 0},
    {"sphincssha2256fsimple", "sphincssha2256fsimple",
     NID_sphincssha2256fsimple, 6, &kObjectData[6375], 0},
    {"sphincssha2256ssimple", "sphincssha2256ssimple",
     NID_sphincssha2256ssimple, 6, &kObjectData[6381], 0},
    {"sphincsshake128fsimple", "sphincsshake128fsimple",
     NID_sphincsshake128fsimple, 6, &kObjectData[6387], 0},
    {"sphincsshake128ssimple", "sphincsshake128ssimple",
     NID_sphincsshake128ssimple, 6, &kObjectData[6393], 0},
    {"sphincsshake192fsimple", "sphincsshake192fsimple",
     NID_sphincsshake192fsimple, 6, &kObjectData[6399], 0},
    {"sphincsshake192ssimple", "sphincsshake192ssimple",
     NID_sphincsshake192ssimple, 6, &kObjectData[6405], 0},
    {"sphincsshake256fsimple", "sphincsshake256fsimple",
     NID_sphincsshake256fsimple, 6, &kObjectData[6411], 0},
    {"sphincsshake256ssimple", "sphincsshake256ssimple",
     NID_sphincsshake256ssimple, 6, &kObjectData[6417], 0},
    {"slhdsapuresha2128s", "slhdsapuresha2128s", NID_slhdsapuresha2128s, 9,
     &kObjectData[6423], 0},
    {"slhdsapuresha2128f", "slhdsapuresha2128f", NID_slhdsapuresha2128f, 9,
     &kObjectData[6432], 0},
    {"slhdsapuresha2192s", "slhdsapuresha2192s", NID_slhdsapuresha2192s, 9,
     &kObjectData[6441], 0},
    {"slhdsapuresha2192f", "slhdsapuresha2192f", NID_slhdsapuresha2192f, 9,
     &kObjectData[6450], 0},
    {"slhdsapuresha2256s", "slhdsapuresha2256s", NID_slhdsapuresha2256s, 9,
     &kObjectData[6459], 0},
    {"slhdsapuresha2256f", "slhdsapuresha2256f", NID_slhdsapuresha2256f, 9,
     &kObjectData[6468], 0},
    {"slhdsapureshake128s", "slhdsapureshake128s", NID_slhdsapureshake128s, 9,
     &kObjectData[6477], 0},
    {"slhdsapureshake128f", "slhdsapureshake128f", NID_slhdsapureshake128f, 9,
     &kObjectData[6486], 0},
    {"slhdsapureshake192s", "slhdsapureshake192s", NID_slhdsapureshake192s, 9,
     &kObjectData[6495], 0},
    {"slhdsapureshake192f", "slhdsapureshake192f", NID_slhdsapureshake192f, 9,
     &kObjectData[6504], 0},
    {"slhdsapureshake256s", "slhdsapureshake256s", NID_slhdsapureshake256s, 9,
     &kObjectData[6513], 0},
    {"slhdsapureshake256f", "slhdsapureshake256f", NID_slhdsapureshake256f, 9,
     &kObjectData[6522], 0},
};
...
static const uint16_t kNIDsInShortNameOrder[] = {
    ...
    999 /* falcon1024 */,
    1000 /* falcon512 */,
    1002 /* falconpadded1024 */,
    1003 /* falconpadded512 */,
    462 /* favouriteDrink */,
    857 /* freshestCRL */,
    453 /* friendlyCountry */,
    ...
    475 /* otherMailbox */,
    876 /* owner */,
    980 /* p256_frodo640aes */,
    983 /* p256_frodo640shake */,
    1009 /* p256_mldsa44 */,
    992 /* p256_mlkem512 */,
    994 /* p256_mlkem768 */,
    972 /* p384_bikel3 */,
    986 /* p384_frodo976aes */,
    988 /* p384_frodo976shake */,
    1011 /* p384_mldsa65 */,
    989 /* p384_mlkem1024 */,
    995 /* p384_mlkem768 */,
    974 /* p521_bikel5 */,
    976 /* p521_frodo1344aes */,
    978 /* p521_frodo1344shake */,
    1013 /* p521_mldsa87 */,
    990 /* p521_mlkem1024 */,
    ...
    1032 /* slhdsapuresha2128f */,
    1031 /* slhdsapuresha2128s */,
    1034 /* slhdsapuresha2192f */,
    1033 /* slhdsapuresha2192s */,
    1036 /* slhdsapuresha2256f */,
    1035 /* slhdsapuresha2256s */,
    1038 /* slhdsapureshake128f */,
    1037 /* slhdsapureshake128s */,
    1040 /* slhdsapureshake192f */,
    1039 /* slhdsapureshake192s */,
    1042 /* slhdsapureshake256f */,
    1041 /* slhdsapureshake256s */,
    387 /* snmpv2 */,
    1014 /* snova2454 */,
    1015 /* snova2454esk */,
    1017 /* snova2455 */,
    1018 /* snova2965 */,
    1016 /* snova37172 */,
    1019 /* sphincssha2128fsimple */,
    1020 /* sphincssha2128ssimple */,
    1021 /* sphincssha2192fsimple */,
    1022 /* sphincssha2192ssimple */,
    1023 /* sphincssha2256fsimple */,
    1024 /* sphincssha2256ssimple */,
    1025 /* sphincsshake128fsimple */,
    1026 /* sphincsshake128ssimple */,
    1027 /* sphincsshake192fsimple */,
    1028 /* sphincsshake192ssimple */,
    1029 /* sphincsshake256fsimple */,
    1030 /* sphincsshake256ssimple */,
    660 /* street */,
    85 /* subjectAltName */,
    ...
    804 /* whirlpool */,
    868 /* x121Address */,
    981 /* x25519_frodo640aes */,
    984 /* x25519_frodo640shake */,
...
static const uint16_t kNIDsInOIDOrder[] = {
    ...
    1000 /* 1.3.9999.3.11 (OBJ_falcon512) */,
    1001 /* 1.3.9999.3.13 (OBJ_rsa3072_falcon512) */,
    999 /* 1.3.9999.3.14 (OBJ_falcon1024) */,
    1003 /* 1.3.9999.3.16 (OBJ_falconpadded512) */,
    1002 /* 1.3.9999.3.19 (OBJ_falconpadded1024) */,
    1009 /* 1.3.9999.7.5 (OBJ_p256_mldsa44) */,
    1011 /* 1.3.9999.7.7 (OBJ_p384_mldsa65) */,
    1013 /* 1.3.9999.7.8 (OBJ_p521_mldsa87) */,
    ...
    1019 /* 1.3.9999.6.4.13 (OBJ_sphincssha2128fsimple) */,
    1020 /* 1.3.9999.6.4.16 (OBJ_sphincssha2128ssimple) */,
    1021 /* 1.3.9999.6.5.10 (OBJ_sphincssha2192fsimple) */,
    1022 /* 1.3.9999.6.5.12 (OBJ_sphincssha2192ssimple) */,
    1023 /* 1.3.9999.6.6.10 (OBJ_sphincssha2256fsimple) */,
    1024 /* 1.3.9999.6.6.12 (OBJ_sphincssha2256ssimple) */,
    1025 /* 1.3.9999.6.7.13 (OBJ_sphincsshake128fsimple) */,
    1026 /* 1.3.9999.6.7.16 (OBJ_sphincsshake128ssimple) */,
    1027 /* 1.3.9999.6.8.10 (OBJ_sphincsshake192fsimple) */,
    1028 /* 1.3.9999.6.8.12 (OBJ_sphincsshake192ssimple) */,
    1029 /* 1.3.9999.6.9.10 (OBJ_sphincsshake256fsimple) */,
    1030 /* 1.3.9999.6.9.12 (OBJ_sphincsshake256ssimple) */,
    1004 /* 1.3.9999.8.1.3 (OBJ_mayo1) */,
    1005 /* 1.3.9999.8.2.3 (OBJ_mayo2) */,
    1006 /* 1.3.9999.8.3.3 (OBJ_mayo3) */,
    1007 /* 1.3.9999.8.5.3 (OBJ_mayo5) */,
    997 /* 1.3.9999.9.6.1 (OBJ_OV_Ip_pkc) */,
    998 /* 1.3.9999.9.10.1 (OBJ_OV_Ip_pkc_skc) */,
    1014 /* 1.3.9999.10.1.1 (OBJ_snova2454) */,
    1015 /* 1.3.9999.10.3.1 (OBJ_snova2454esk) */,
    1016 /* 1.3.9999.10.5.1 (OBJ_snova37172) */,
    1017 /* 1.3.9999.10.10.1 (OBJ_snova2455) */,
    1018 /* 1.3.9999.10.12.1 (OBJ_snova2965) */,
    ...
    1008 /* 2.16.840.1.101.3.4.3.17 (OBJ_mldsa44) */,
    1010 /* 2.16.840.1.101.3.4.3.18 (OBJ_mldsa65) */,
    1012 /* 2.16.840.1.101.3.4.3.19 (OBJ_mldsa87) */,
    1031 /* 2.16.840.1.101.3.4.3.20 (OBJ_slhdsapuresha2128s) */,
    1032 /* 2.16.840.1.101.3.4.3.21 (OBJ_slhdsapuresha2128f) */,
    1033 /* 2.16.840.1.101.3.4.3.22 (OBJ_slhdsapuresha2192s) */,
    1034 /* 2.16.840.1.101.3.4.3.23 (OBJ_slhdsapuresha2192f) */,
    1035 /* 2.16.840.1.101.3.4.3.24 (OBJ_slhdsapuresha2256s) */,
    1036 /* 2.16.840.1.101.3.4.3.25 (OBJ_slhdsapuresha2256f) */,
    1037 /* 2.16.840.1.101.3.4.3.26 (OBJ_slhdsapureshake128s) */,
    1038 /* 2.16.840.1.101.3.4.3.27 (OBJ_slhdsapureshake128f) */,
    1039 /* 2.16.840.1.101.3.4.3.28 (OBJ_slhdsapureshake192s) */,
    1040 /* 2.16.840.1.101.3.4.3.29 (OBJ_slhdsapureshake192f) */,
    1041 /* 2.16.840.1.101.3.4.3.30 (OBJ_slhdsapureshake256s) */,
    1042 /* 2.16.840.1.101.3.4.3.31 (OBJ_slhdsapureshake256f) */,
    ...
    996 /* 1.3.6.1.4.1.62245.2.1.1.2.2 (OBJ_CROSSrsdp128balanced) */,
};
