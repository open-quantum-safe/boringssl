...
static const ASN1_OBJECT kObjects[NUM_NID] = {
    ...
    {"p256_mldsa44", "p256_mldsa44", NID_p256_mldsa44, 5, &kObjectData[6205],
     0},
    {"p384_mldsa65", "p384_mldsa65", NID_p384_mldsa65, 5, &kObjectData[6210],
     0},
    {"p521_mldsa87", "p521_mldsa87", NID_p521_mldsa87, 5, &kObjectData[6215],
     0},
    {"CROSSrsdp128balanced", "CROSSrsdp128balanced", NID_CROSSrsdp128balanced,
     13, &kObjectData[6220], 0},
    {"OV_Ip_pkc", "OV_Ip_pkc", NID_OV_Ip_pkc, 6, &kObjectData[6233], 0},
    {"OV_Ip_pkc_skc", "OV_Ip_pkc_skc", NID_OV_Ip_pkc_skc, 6, &kObjectData[6239],
     0},
    {"falcon512", "falcon512", NID_falcon512, 5, &kObjectData[6245], 0},
    {"rsa3072_falcon512", "rsa3072_falcon512", NID_rsa3072_falcon512, 5,
     &kObjectData[6250], 0},
    {"falconpadded512", "falconpadded512", NID_falconpadded512, 5,
     &kObjectData[6255], 0},
    {"falcon1024", "falcon1024", NID_falcon1024, 5, &kObjectData[6260], 0},
    {"falconpadded1024", "falconpadded1024", NID_falconpadded1024, 5,
     &kObjectData[6265], 0},
    {"mayo1", "mayo1", NID_mayo1, 6, &kObjectData[6270], 0},
    {"mayo2", "mayo2", NID_mayo2, 6, &kObjectData[6276], 0},
    {"mayo3", "mayo3", NID_mayo3, 6, &kObjectData[6282], 0},
    {"mayo5", "mayo5", NID_mayo5, 6, &kObjectData[6288], 0},
    {"snova2454", "snova2454", NID_snova2454, 6, &kObjectData[6294], 0},
    {"snova2454esk", "snova2454esk", NID_snova2454esk, 6, &kObjectData[6300],
     0},
    {"snova37172", "snova37172", NID_snova37172, 6, &kObjectData[6306], 0},
    {"snova2455", "snova2455", NID_snova2455, 6, &kObjectData[6312], 0},
    {"snova2965", "snova2965", NID_snova2965, 6, &kObjectData[6318], 0},
    {"sphincssha2128fsimple", "sphincssha2128fsimple",
     NID_sphincssha2128fsimple, 6, &kObjectData[6324], 0},
    {"sphincssha2128ssimple", "sphincssha2128ssimple",
     NID_sphincssha2128ssimple, 6, &kObjectData[6330], 0},
    {"sphincssha2192fsimple", "sphincssha2192fsimple",
     NID_sphincssha2192fsimple, 6, &kObjectData[6336], 0},
    {"sphincssha2192ssimple", "sphincssha2192ssimple",
     NID_sphincssha2192ssimple, 6, &kObjectData[6342], 0},
    {"sphincssha2256fsimple", "sphincssha2256fsimple",
     NID_sphincssha2256fsimple, 6, &kObjectData[6348], 0},
    {"sphincssha2256ssimple", "sphincssha2256ssimple",
     NID_sphincssha2256ssimple, 6, &kObjectData[6354], 0},
    {"sphincsshake128fsimple", "sphincsshake128fsimple",
     NID_sphincsshake128fsimple, 6, &kObjectData[6360], 0},
    {"sphincsshake128ssimple", "sphincsshake128ssimple",
     NID_sphincsshake128ssimple, 6, &kObjectData[6366], 0},
    {"sphincsshake192fsimple", "sphincsshake192fsimple",
     NID_sphincsshake192fsimple, 6, &kObjectData[6372], 0},
    {"sphincsshake192ssimple", "sphincsshake192ssimple",
     NID_sphincsshake192ssimple, 6, &kObjectData[6378], 0},
    {"sphincsshake256fsimple", "sphincsshake256fsimple",
     NID_sphincsshake256fsimple, 6, &kObjectData[6384], 0},
    {"sphincsshake256ssimple", "sphincsshake256ssimple",
     NID_sphincsshake256ssimple, 6, &kObjectData[6390], 0},
    ...
    {"mldsa44", "mldsa44", NID_mldsa44, 9, &kObjectData[6396], 0},
    {"mldsa65", "mldsa65", NID_mldsa65, 9, &kObjectData[6405], 0},
    {"mldsa87", "mldsa87", NID_mldsa87, 9, &kObjectData[6414], 0},
    {"slhdsa_sha2_128s", "slhdsa_sha2_128s", NID_slhdsa_sha2_128s, 9,
     &kObjectData[6423], 0},
    {"slhdsa_sha2_128f", "slhdsa_sha2_128f", NID_slhdsa_sha2_128f, 9,
     &kObjectData[6432], 0},
    {"slhdsa_sha2_192s", "slhdsa_sha2_192s", NID_slhdsa_sha2_192s, 9,
     &kObjectData[6441], 0},
    {"slhdsa_sha2_192f", "slhdsa_sha2_192f", NID_slhdsa_sha2_192f, 9,
     &kObjectData[6450], 0},
    {"slhdsa_sha2_256s", "slhdsa_sha2_256s", NID_slhdsa_sha2_256s, 9,
     &kObjectData[6459], 0},
    {"slhdsa_sha2_256f", "slhdsa_sha2_256f", NID_slhdsa_sha2_256f, 9,
     &kObjectData[6468], 0},
    {"slhdsa_shake_128s", "slhdsa_shake_128s", NID_slhdsa_shake_128s, 9,
     &kObjectData[6477], 0},
    {"slhdsa_shake_128f", "slhdsa_shake_128f", NID_slhdsa_shake_128f, 9,
     &kObjectData[6486], 0},
    {"slhdsa_shake_192s", "slhdsa_shake_192s", NID_slhdsa_shake_192s, 9,
     &kObjectData[6495], 0},
    {"slhdsa_shake_192f", "slhdsa_shake_192f", NID_slhdsa_shake_192f, 9,
     &kObjectData[6504], 0},
    {"slhdsa_shake_256s", "slhdsa_shake_256s", NID_slhdsa_shake_256s, 9,
     &kObjectData[6513], 0},
    {"slhdsa_shake_256f", "slhdsa_shake_256f", NID_slhdsa_shake_256f, 9,
     &kObjectData[6522], 0},
};
...
static const uint16_t kNIDsInShortNameOrder[] = {
    ...
    475 /* otherMailbox */,
    876 /* owner */,
    975 /* p256_frodo640aes */,
    978 /* p256_frodo640shake */,
    995 /* p256_mldsa44 */,
    972 /* p256_mlkem512 */,
    1030 /* p256_mlkem768 */,
    992 /* p384_bikel3 */,
    981 /* p384_frodo976aes */,
    983 /* p384_frodo976shake */,
    996 /* p384_mldsa65 */,
    1027 /* p384_mlkem1024 */,
    1031 /* p384_mlkem768 */,
    994 /* p521_bikel5 */,
    985 /* p521_frodo1344aes */,
    987 /* p521_frodo1344shake */,
    997 /* p521_mldsa87 */,
    1028 /* p521_mlkem1024 */,
    ...
    1036 /* slhdsa_sha2_128f */,
    1035 /* slhdsa_sha2_128s */,
    1038 /* slhdsa_sha2_192f */,
    1037 /* slhdsa_sha2_192s */,
    1040 /* slhdsa_sha2_256f */,
    1039 /* slhdsa_sha2_256s */,
    1042 /* slhdsa_shake_128f */,
    1041 /* slhdsa_shake_128s */,
    1044 /* slhdsa_shake_192f */,
    1043 /* slhdsa_shake_192s */,
    1046 /* slhdsa_shake_256f */,
    1045 /* slhdsa_shake_256s */,
    387 /* snmpv2 */,
    1010 /* snova2454 */,
    1011 /* snova2454esk */,
    1013 /* snova2455 */,
    1014 /* snova2965 */,
    1012 /* snova37172 */,
    1015 /* sphincssha2128fsimple */,
    1016 /* sphincssha2128ssimple */,
    1017 /* sphincssha2192fsimple */,
    1018 /* sphincssha2192ssimple */,
    1019 /* sphincssha2256fsimple */,
    1020 /* sphincssha2256ssimple */,
    1021 /* sphincsshake128fsimple */,
    1022 /* sphincsshake128ssimple */,
    1023 /* sphincsshake192fsimple */,
    1024 /* sphincsshake192ssimple */,
    1025 /* sphincsshake256fsimple */,
    1026 /* sphincsshake256ssimple */,
    660 /* street */,
    85 /* subjectAltName */,
    ...
    804 /* whirlpool */,
    868 /* x121Address */,
    976 /* x25519_frodo640aes */,
    979 /* x25519_frodo640shake */,
...
static const uint16_t kNIDsInOIDOrder[] = {
    ...
    1001 /* 1.3.9999.3.11 (OBJ_falcon512) */,
    1002 /* 1.3.9999.3.13 (OBJ_rsa3072_falcon512) */,
    1004 /* 1.3.9999.3.14 (OBJ_falcon1024) */,
    1003 /* 1.3.9999.3.16 (OBJ_falconpadded512) */,
    1005 /* 1.3.9999.3.19 (OBJ_falconpadded1024) */,
    995 /* 1.3.9999.7.5 (OBJ_p256_mldsa44) */,
    996 /* 1.3.9999.7.7 (OBJ_p384_mldsa65) */,
    997 /* 1.3.9999.7.8 (OBJ_p521_mldsa87) */,
    ...
    1015 /* 1.3.9999.6.4.13 (OBJ_sphincssha2128fsimple) */,
    1016 /* 1.3.9999.6.4.16 (OBJ_sphincssha2128ssimple) */,
    1017 /* 1.3.9999.6.5.10 (OBJ_sphincssha2192fsimple) */,
    1018 /* 1.3.9999.6.5.12 (OBJ_sphincssha2192ssimple) */,
    1019 /* 1.3.9999.6.6.10 (OBJ_sphincssha2256fsimple) */,
    1020 /* 1.3.9999.6.6.12 (OBJ_sphincssha2256ssimple) */,
    1021 /* 1.3.9999.6.7.13 (OBJ_sphincsshake128fsimple) */,
    1022 /* 1.3.9999.6.7.16 (OBJ_sphincsshake128ssimple) */,
    1023 /* 1.3.9999.6.8.10 (OBJ_sphincsshake192fsimple) */,
    1024 /* 1.3.9999.6.8.12 (OBJ_sphincsshake192ssimple) */,
    1025 /* 1.3.9999.6.9.10 (OBJ_sphincsshake256fsimple) */,
    1026 /* 1.3.9999.6.9.12 (OBJ_sphincsshake256ssimple) */,
    1006 /* 1.3.9999.8.1.3 (OBJ_mayo1) */,
    1007 /* 1.3.9999.8.2.3 (OBJ_mayo2) */,
    1008 /* 1.3.9999.8.3.3 (OBJ_mayo3) */,
    1009 /* 1.3.9999.8.5.3 (OBJ_mayo5) */,
    999 /* 1.3.9999.9.6.1 (OBJ_OV_Ip_pkc) */,
    1000 /* 1.3.9999.9.10.1 (OBJ_OV_Ip_pkc_skc) */,
    1010 /* 1.3.9999.10.1.1 (OBJ_snova2454) */,
    1011 /* 1.3.9999.10.3.1 (OBJ_snova2454esk) */,
    1012 /* 1.3.9999.10.5.1 (OBJ_snova37172) */,
    1013 /* 1.3.9999.10.10.1 (OBJ_snova2455) */,
    1014 /* 1.3.9999.10.12.1 (OBJ_snova2965) */,
    ...
    1032 /* 2.16.840.1.101.3.4.3.17 (OBJ_mldsa44) */,
    1033 /* 2.16.840.1.101.3.4.3.18 (OBJ_mldsa65) */,
    1034 /* 2.16.840.1.101.3.4.3.19 (OBJ_mldsa87) */,
    1035 /* 2.16.840.1.101.3.4.3.20 (OBJ_slhdsa_sha2_128s) */,
    1036 /* 2.16.840.1.101.3.4.3.21 (OBJ_slhdsa_sha2_128f) */,
    1037 /* 2.16.840.1.101.3.4.3.22 (OBJ_slhdsa_sha2_192s) */,
    1038 /* 2.16.840.1.101.3.4.3.23 (OBJ_slhdsa_sha2_192f) */,
    1039 /* 2.16.840.1.101.3.4.3.24 (OBJ_slhdsa_sha2_256s) */,
    1040 /* 2.16.840.1.101.3.4.3.25 (OBJ_slhdsa_sha2_256f) */,
    1041 /* 2.16.840.1.101.3.4.3.26 (OBJ_slhdsa_shake_128s) */,
    1042 /* 2.16.840.1.101.3.4.3.27 (OBJ_slhdsa_shake_128f) */,
    1043 /* 2.16.840.1.101.3.4.3.28 (OBJ_slhdsa_shake_192s) */,
    1044 /* 2.16.840.1.101.3.4.3.29 (OBJ_slhdsa_shake_192f) */,
    1045 /* 2.16.840.1.101.3.4.3.30 (OBJ_slhdsa_shake_256s) */,
    1046 /* 2.16.840.1.101.3.4.3.31 (OBJ_slhdsa_shake_256f) */,
    ...
    998 /* 1.3.6.1.4.1.62245.2.1.1.2.2 (OBJ_CROSSrsdp128balanced) */,
};
