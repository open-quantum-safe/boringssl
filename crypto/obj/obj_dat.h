...
static const ASN1_OBJECT kObjects[NUM_NID] = {
    ...
    {"CROSSrsdp128balanced", "CROSSrsdp128balanced", NID_CROSSrsdp128balanced,
     12, &kObjectData[6299], 0},
    {"snova2454", "snova2454", NID_snova2454, 6, &kObjectData[6311], 0},
    {"snova2454esk", "snova2454esk", NID_snova2454esk, 6, &kObjectData[6317],
     0},
    {"snova37172", "snova37172", NID_snova37172, 6, &kObjectData[6323], 0},
    {"snova2455", "snova2455", NID_snova2455, 6, &kObjectData[6329], 0},
    {"snova2965", "snova2965", NID_snova2965, 6, &kObjectData[6335], 0},
    {"sphincssha2128fsimple", "sphincssha2128fsimple",
     NID_sphincssha2128fsimple, 6, &kObjectData[6341], 0},
    {"sphincssha2128ssimple", "sphincssha2128ssimple",
     NID_sphincssha2128ssimple, 6, &kObjectData[6347], 0},
    {"sphincssha2192fsimple", "sphincssha2192fsimple",
     NID_sphincssha2192fsimple, 6, &kObjectData[6353], 0},
    {"sphincssha2192ssimple", "sphincssha2192ssimple",
     NID_sphincssha2192ssimple, 6, &kObjectData[6359], 0},
    {"sphincssha2256fsimple", "sphincssha2256fsimple",
     NID_sphincssha2256fsimple, 6, &kObjectData[6365], 0},
    {"sphincssha2256ssimple", "sphincssha2256ssimple",
     NID_sphincssha2256ssimple, 6, &kObjectData[6371], 0},
    {"sphincsshake128fsimple", "sphincsshake128fsimple",
     NID_sphincsshake128fsimple, 6, &kObjectData[6377], 0},
    {"sphincsshake128ssimple", "sphincsshake128ssimple",
     NID_sphincsshake128ssimple, 6, &kObjectData[6383], 0},
    {"sphincsshake192fsimple", "sphincsshake192fsimple",
     NID_sphincsshake192fsimple, 6, &kObjectData[6389], 0},
    {"sphincsshake192ssimple", "sphincsshake192ssimple",
     NID_sphincsshake192ssimple, 6, &kObjectData[6395], 0},
    {"sphincsshake256fsimple", "sphincsshake256fsimple",
     NID_sphincsshake256fsimple, 6, &kObjectData[6401], 0},
    {"sphincsshake256ssimple", "sphincsshake256ssimple",
     NID_sphincsshake256ssimple, 6, &kObjectData[6407], 0},
};
...
static const uint16_t kNIDsInOIDOrder[] = {
    ...
    1013 /* 1.3.6.1.4.1.62245.2.1.1.2 (OBJ_CROSSrsdp128balanced) */,
};
