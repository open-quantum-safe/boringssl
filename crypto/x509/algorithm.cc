...
///// OQS_TEMPLATE_FRAGMENT_CHECK_PKEY_ID_START
      ...
      pkey_id == EVP_PKEY_SLHDSAPURESHA2128S ||
      pkey_id == EVP_PKEY_SLHDSAPURESHA2128F ||
      pkey_id == EVP_PKEY_SLHDSAPURESHA2192S ||
      pkey_id == EVP_PKEY_SLHDSAPURESHA2192F ||
      pkey_id == EVP_PKEY_SLHDSAPURESHA2256S ||
      pkey_id == EVP_PKEY_SLHDSAPURESHA2256F ||
      pkey_id == EVP_PKEY_SLHDSAPURESHAKE128S ||
      pkey_id == EVP_PKEY_SLHDSAPURESHAKE128F ||
      pkey_id == EVP_PKEY_SLHDSAPURESHAKE192S ||
      pkey_id == EVP_PKEY_SLHDSAPURESHAKE192F ||
      pkey_id == EVP_PKEY_SLHDSAPURESHAKE256S ||
      pkey_id == EVP_PKEY_SLHDSAPURESHAKE256F
