...
DEFINE_OQS_PKEY_METHODS(OV_Is_pkc, OQS_SIG_alg_uov_ov_Is_pkc, EVP_PKEY_OV_IS_PKC)
DEFINE_OQS_PKEY_METHODS(OV_Ip_pkc, OQS_SIG_alg_uov_ov_Ip_pkc, EVP_PKEY_OV_IP_PKC)
DEFINE_OQS_PKEY_METHODS(OV_Is_pkc_skc, OQS_SIG_alg_uov_ov_Is_pkc_skc, EVP_PKEY_OV_IS_PKC_SKC)
