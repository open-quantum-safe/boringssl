...
DEFINE_OQS_PKEY_ASN1_METHOD(sphincssha2128fsimple, EVP_PKEY_SPHINCSSHA2128FSIMPLE, OID(0x2B, 0xCE, 0x0F, 0x06, 0x04, 0x04))

DEFINE_OQS_ASN1_METHODS(sphincssha2128ssimple, OQS_SIG_alg_sphincs_sha2_128s_simple, EVP_PKEY_SPHINCSSHA2128SSIMPLE)
DEFINE_OQS_PKEY_ASN1_METHOD(sphincssha2128ssimple, EVP_PKEY_SPHINCSSHA2128SSIMPLE, OID(0x2B, 0xCE, 0x0F, 0x06, 0x04, 0x0A))

DEFINE_OQS_ASN1_METHODS(sphincssha2192fsimple, OQS_SIG_alg_sphincs_sha2_192f_simple, EVP_PKEY_SPHINCSSHA2192FSIMPLE)
DEFINE_OQS_PKEY_ASN1_METHOD(sphincssha2192fsimple, EVP_PKEY_SPHINCSSHA2192FSIMPLE, OID(0x2B, 0xCE, 0x0F, 0x06, 0x05, 0x03))

DEFINE_OQS_ASN1_METHODS(sphincssha2192ssimple, OQS_SIG_alg_sphincs_sha2_192s_simple, EVP_PKEY_SPHINCSSHA2192SSIMPLE)
DEFINE_OQS_PKEY_ASN1_METHOD(sphincssha2192ssimple, EVP_PKEY_SPHINCSSHA2192SSIMPLE, OID(0x2B, 0xCE, 0x0F, 0x06, 0x05, 0x07))

DEFINE_OQS_ASN1_METHODS(sphincssha2256fsimple, OQS_SIG_alg_sphincs_sha2_256f_simple, EVP_PKEY_SPHINCSSHA2256FSIMPLE)
DEFINE_OQS_PKEY_ASN1_METHOD(sphincssha2256fsimple, EVP_PKEY_SPHINCSSHA2256FSIMPLE, OID(0x2B, 0xCE, 0x0F, 0x06, 0x06, 0x03))

DEFINE_OQS_ASN1_METHODS(sphincssha2256ssimple, OQS_SIG_alg_sphincs_sha2_256s_simple, EVP_PKEY_SPHINCSSHA2256SSIMPLE)
DEFINE_OQS_PKEY_ASN1_METHOD(sphincssha2256ssimple, EVP_PKEY_SPHINCSSHA2256SSIMPLE, OID(0x2B, 0xCE, 0x0F, 0x06, 0x06, 0x07))

DEFINE_OQS_ASN1_METHODS(sphincsshake128fsimple, OQS_SIG_alg_sphincs_shake_128f_simple, EVP_PKEY_SPHINCSSHAKE128FSIMPLE)
DEFINE_OQS_PKEY_ASN1_METHOD(sphincsshake128fsimple, EVP_PKEY_SPHINCSSHAKE128FSIMPLE, OID(0x2B, 0xCE, 0x0F, 0x06, 0x07, 0x04))

DEFINE_OQS_ASN1_METHODS(sphincsshake128ssimple, OQS_SIG_alg_sphincs_shake_128s_simple, EVP_PKEY_SPHINCSSHAKE128SSIMPLE)
DEFINE_OQS_PKEY_ASN1_METHOD(sphincsshake128ssimple, EVP_PKEY_SPHINCSSHAKE128SSIMPLE, OID(0x2B, 0xCE, 0x0F, 0x06, 0x07, 0x0A))

DEFINE_OQS_ASN1_METHODS(sphincsshake192fsimple, OQS_SIG_alg_sphincs_shake_192f_simple, EVP_PKEY_SPHINCSSHAKE192FSIMPLE)
DEFINE_OQS_PKEY_ASN1_METHOD(sphincsshake192fsimple, EVP_PKEY_SPHINCSSHAKE192FSIMPLE, OID(0x2B, 0xCE, 0x0F, 0x06, 0x08, 0x03))

DEFINE_OQS_ASN1_METHODS(sphincsshake192ssimple, OQS_SIG_alg_sphincs_shake_192s_simple, EVP_PKEY_SPHINCSSHAKE192SSIMPLE)
DEFINE_OQS_PKEY_ASN1_METHOD(sphincsshake192ssimple, EVP_PKEY_SPHINCSSHAKE192SSIMPLE, OID(0x2B, 0xCE, 0x0F, 0x06, 0x08, 0x07))

DEFINE_OQS_ASN1_METHODS(sphincsshake256fsimple, OQS_SIG_alg_sphincs_shake_256f_simple, EVP_PKEY_SPHINCSSHAKE256FSIMPLE)
DEFINE_OQS_PKEY_ASN1_METHOD(sphincsshake256fsimple, EVP_PKEY_SPHINCSSHAKE256FSIMPLE, OID(0x2B, 0xCE, 0x0F, 0x06, 0x09, 0x03))

DEFINE_OQS_ASN1_METHODS(sphincsshake256ssimple, OQS_SIG_alg_sphincs_shake_256s_simple, EVP_PKEY_SPHINCSSHAKE256SSIMPLE)
DEFINE_OQS_PKEY_ASN1_METHOD(sphincsshake256ssimple, EVP_PKEY_SPHINCSSHAKE256SSIMPLE, OID(0x2B, 0xCE, 0x0F, 0x06, 0x09, 0x07))
