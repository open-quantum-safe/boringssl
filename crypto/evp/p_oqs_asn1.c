...
DEFINE_OQS_PKEY_ASN1_METHOD(falcon512, EVP_PKEY_FALCON512, OID(0x2B, 0xCE, 0x0F, 0x03, 0x02))
...
DEFINE_OQS_PKEY_ASN1_METHOD(mqdss3164, EVP_PKEY_MQDSS3164, OID(0x2B, 0xCE, 0x0F, 0x04, 0x02))
