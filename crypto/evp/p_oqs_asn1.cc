...
static int oqs_pub_cmp(const EVP_PKEY *a, const EVP_PKEY *b) {
  const OQS_KEY *a_key = reinterpret_cast<OQS_KEY *>(a->pkey);
  const OQS_KEY *b_key = reinterpret_cast<OQS_KEY *>(b->pkey);
...
const EVP_PKEY_ALG *EVP_pkey_snova2454(void) {
  static const EVP_PKEY_ALG kAlg = { &snova2454_asn1_meth };
  return &kAlg;
}
...
const EVP_PKEY_ALG *EVP_pkey_slhdsapuresha2128s(void) {
  static const EVP_PKEY_ALG kAlg = { &slhdsapuresha2128s_asn1_meth };
  return &kAlg;
}
const EVP_PKEY_ALG *EVP_pkey_slhdsapuresha2128f(void) {
  static const EVP_PKEY_ALG kAlg = { &slhdsapuresha2128f_asn1_meth };
  return &kAlg;
}
const EVP_PKEY_ALG *EVP_pkey_slhdsapuresha2192s(void) {
  static const EVP_PKEY_ALG kAlg = { &slhdsapuresha2192s_asn1_meth };
  return &kAlg;
}
const EVP_PKEY_ALG *EVP_pkey_slhdsapuresha2192f(void) {
  static const EVP_PKEY_ALG kAlg = { &slhdsapuresha2192f_asn1_meth };
  return &kAlg;
}
const EVP_PKEY_ALG *EVP_pkey_slhdsapuresha2256s(void) {
  static const EVP_PKEY_ALG kAlg = { &slhdsapuresha2256s_asn1_meth };
  return &kAlg;
}
const EVP_PKEY_ALG *EVP_pkey_slhdsapuresha2256f(void) {
  static const EVP_PKEY_ALG kAlg = { &slhdsapuresha2256f_asn1_meth };
  return &kAlg;
}
const EVP_PKEY_ALG *EVP_pkey_slhdsapureshake128s(void) {
  static const EVP_PKEY_ALG kAlg = { &slhdsapureshake128s_asn1_meth };
  return &kAlg;
}
const EVP_PKEY_ALG *EVP_pkey_slhdsapureshake128f(void) {
  static const EVP_PKEY_ALG kAlg = { &slhdsapureshake128f_asn1_meth };
  return &kAlg;
}
const EVP_PKEY_ALG *EVP_pkey_slhdsapureshake192s(void) {
  static const EVP_PKEY_ALG kAlg = { &slhdsapureshake192s_asn1_meth };
  return &kAlg;
}
const EVP_PKEY_ALG *EVP_pkey_slhdsapureshake192f(void) {
  static const EVP_PKEY_ALG kAlg = { &slhdsapureshake192f_asn1_meth };
  return &kAlg;
}
const EVP_PKEY_ALG *EVP_pkey_slhdsapureshake256s(void) {
  static const EVP_PKEY_ALG kAlg = { &slhdsapureshake256s_asn1_meth };
  return &kAlg;
}
const EVP_PKEY_ALG *EVP_pkey_slhdsapureshake256f(void) {
  static const EVP_PKEY_ALG kAlg = { &slhdsapureshake256f_asn1_meth };
  return &kAlg;
}
...
static int decode_EC_pub(int nid, const unsigned char *encoded_key, int key_len,
                         OQS_KEY *oqs_key) {
  ...
  if ((ec_key = EC_KEY_new()) == NULL || !EC_KEY_set_group(ec_key, ecgroup)) {
    goto end;
  }
...
DEFINE_OQS_ASN1_METHODS(snova2454esk, OQS_SIG_alg_snova_SNOVA_24_5_4_esk, EVP_PKEY_SNOVA2454ESK)
DEFINE_OQS_PKEY_ASN1_METHOD(snova2454esk, EVP_PKEY_SNOVA2454ESK, OID(0x2B, 0xCE, 0x0F, 0x0A, 0x03, 0x01))

DEFINE_OQS_ASN1_METHODS(snova37172, OQS_SIG_alg_snova_SNOVA_37_17_2, EVP_PKEY_SNOVA37172)
DEFINE_OQS_PKEY_ASN1_METHOD(snova37172, EVP_PKEY_SNOVA37172, OID(0x2B, 0xCE, 0x0F, 0x0A, 0x05, 0x01))

DEFINE_OQS_ASN1_METHODS(snova2455, OQS_SIG_alg_snova_SNOVA_24_5_5, EVP_PKEY_SNOVA2455)
DEFINE_OQS_PKEY_ASN1_METHOD(snova2455, EVP_PKEY_SNOVA2455, OID(0x2B, 0xCE, 0x0F, 0x0A, 0x0A, 0x01))

DEFINE_OQS_ASN1_METHODS(snova2965, OQS_SIG_alg_snova_SNOVA_29_6_5, EVP_PKEY_SNOVA2965)
DEFINE_OQS_PKEY_ASN1_METHOD(snova2965, EVP_PKEY_SNOVA2965, OID(0x2B, 0xCE, 0x0F, 0x0A, 0x0C, 0x01))
...
DEFINE_OQS_ASN1_METHODS(slhdsapuresha2128s, OQS_SIG_alg_slh_dsa_pure_sha2_128s, EVP_PKEY_SLHDSAPURESHA2128S)
DEFINE_OQS_PKEY_ASN1_METHOD(slhdsapuresha2128s, EVP_PKEY_SLHDSAPURESHA2128S, OID(0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x03, 0x14))

DEFINE_OQS_ASN1_METHODS(slhdsapuresha2128f, OQS_SIG_alg_slh_dsa_pure_sha2_128f, EVP_PKEY_SLHDSAPURESHA2128F)
DEFINE_OQS_PKEY_ASN1_METHOD(slhdsapuresha2128f, EVP_PKEY_SLHDSAPURESHA2128F, OID(0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x03, 0x15))

DEFINE_OQS_ASN1_METHODS(slhdsapuresha2192s, OQS_SIG_alg_slh_dsa_pure_sha2_192s, EVP_PKEY_SLHDSAPURESHA2192S)
DEFINE_OQS_PKEY_ASN1_METHOD(slhdsapuresha2192s, EVP_PKEY_SLHDSAPURESHA2192S, OID(0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x03, 0x16))

DEFINE_OQS_ASN1_METHODS(slhdsapuresha2192f, OQS_SIG_alg_slh_dsa_pure_sha2_192f, EVP_PKEY_SLHDSAPURESHA2192F)
DEFINE_OQS_PKEY_ASN1_METHOD(slhdsapuresha2192f, EVP_PKEY_SLHDSAPURESHA2192F, OID(0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x03, 0x17))

DEFINE_OQS_ASN1_METHODS(slhdsapuresha2256s, OQS_SIG_alg_slh_dsa_pure_sha2_256s, EVP_PKEY_SLHDSAPURESHA2256S)
DEFINE_OQS_PKEY_ASN1_METHOD(slhdsapuresha2256s, EVP_PKEY_SLHDSAPURESHA2256S, OID(0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x03, 0x18))

DEFINE_OQS_ASN1_METHODS(slhdsapuresha2256f, OQS_SIG_alg_slh_dsa_pure_sha2_256f, EVP_PKEY_SLHDSAPURESHA2256F)
DEFINE_OQS_PKEY_ASN1_METHOD(slhdsapuresha2256f, EVP_PKEY_SLHDSAPURESHA2256F, OID(0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x03, 0x19))

DEFINE_OQS_ASN1_METHODS(slhdsapureshake128s, OQS_SIG_alg_slh_dsa_pure_shake_128s, EVP_PKEY_SLHDSAPURESHAKE128S)
DEFINE_OQS_PKEY_ASN1_METHOD(slhdsapureshake128s, EVP_PKEY_SLHDSAPURESHAKE128S, OID(0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x03, 0x1A))

DEFINE_OQS_ASN1_METHODS(slhdsapureshake128f, OQS_SIG_alg_slh_dsa_pure_shake_128f, EVP_PKEY_SLHDSAPURESHAKE128F)
DEFINE_OQS_PKEY_ASN1_METHOD(slhdsapureshake128f, EVP_PKEY_SLHDSAPURESHAKE128F, OID(0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x03, 0x1B))

DEFINE_OQS_ASN1_METHODS(slhdsapureshake192s, OQS_SIG_alg_slh_dsa_pure_shake_192s, EVP_PKEY_SLHDSAPURESHAKE192S)
DEFINE_OQS_PKEY_ASN1_METHOD(slhdsapureshake192s, EVP_PKEY_SLHDSAPURESHAKE192S, OID(0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x03, 0x1C))

DEFINE_OQS_ASN1_METHODS(slhdsapureshake192f, OQS_SIG_alg_slh_dsa_pure_shake_192f, EVP_PKEY_SLHDSAPURESHAKE192F)
DEFINE_OQS_PKEY_ASN1_METHOD(slhdsapureshake192f, EVP_PKEY_SLHDSAPURESHAKE192F, OID(0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x03, 0x1D))

DEFINE_OQS_ASN1_METHODS(slhdsapureshake256s, OQS_SIG_alg_slh_dsa_pure_shake_256s, EVP_PKEY_SLHDSAPURESHAKE256S)
DEFINE_OQS_PKEY_ASN1_METHOD(slhdsapureshake256s, EVP_PKEY_SLHDSAPURESHAKE256S, OID(0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x03, 0x1E))

DEFINE_OQS_ASN1_METHODS(slhdsapureshake256f, OQS_SIG_alg_slh_dsa_pure_shake_256f, EVP_PKEY_SLHDSAPURESHAKE256F)
DEFINE_OQS_PKEY_ASN1_METHOD(slhdsapureshake256f, EVP_PKEY_SLHDSAPURESHAKE256F, OID(0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x03, 0x1F))
