...
DEFINE_OQS_ASN1_METHODS(OV_Is_pkc, OQS_SIG_alg_uov_ov_Is_pkc, EVP_PKEY_OV_IS_PKC)
DEFINE_OQS_PKEY_ASN1_METHOD(OV_Is_pkc, EVP_PKEY_OV_IS_PKC, OID(0x2B, 0xCE, 0x0F, 0x09, 0x05, 0x01))
...
DEFINE_OQS_ASN1_METHODS(OV_Is_pkc_skc, OQS_SIG_alg_uov_ov_Is_pkc_skc, EVP_PKEY_OV_IS_PKC_SKC)
DEFINE_OQS_PKEY_ASN1_METHOD(OV_Is_pkc_skc, EVP_PKEY_OV_IS_PKC_SKC, OID(0x2B, 0xCE, 0x0F, 0x09, 0x09, 0x01))
